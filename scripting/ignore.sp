...
public OnPluginStart()
{
    ...
    RegConsoleCmd("sm_ignore",   Command_Ignore,   "Usage: sm_ignore <#userid|name>\nSet target's communications to be ignored.");
    RegConsoleCmd("sm_block",    Command_Ignore,   "Usage: sm_block <#userid|name>\nSet target's communications to be ignored.");
    RegConsoleCmd("sm_unignore", Command_UnIgnore, "Usage: sm_unignore <#userid|name>\nUnignore target.");
    RegConsoleCmd("sm_unblock",  Command_UnIgnore, "Usage: sm_unblock <#userid|name>\nUnignore target.");
...
public Action:Command_Ignore(client, argc)
{
...
public Action:Menu_PlayerList(iClient)
{
...
public MenuHandler_PlayerList(Handle:hMenu, MenuAction:iAction, iClient, iParam)
{
    switch (iAction)
    {
        ...
        {
            decl String:szUserid[32]; // Grab the Userid of player to check ignore status
...
public Action:Menu_IgnoreList(iClient, iTarget)
{
    ...
    AddMenuItem(hIgnoreListMenu, "0", "Chat (hidden)");
    AddMenuItem(hIgnoreListMenu, "1", "Mic (hidden)");
